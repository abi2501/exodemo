...
class StepProgressBar(QWidget):
    ...
    def updateBar(self):
        ...
        for i in range(1, self.steps):
            ...
            self.label_row.addSpacing(30)  # same as connector length
...
def main():
    ...
    window.setStyleSheet("background-color: #2c2f3a;")
    window.setWindowTitle("Progress Bar with Labels")
